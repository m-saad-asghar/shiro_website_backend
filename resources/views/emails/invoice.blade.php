...
<table width="600" align="center" cellpadding="0" cellspacing="0" style="border:1px solid #eee; background-color: #fff; margin-top: 20px;">
    ...
    <tr>
        <td style="text-align: center; padding: 20px;">
            <img src="{{ url('/logo.png') }}" alt="logo" style="max-width: 150px;">
            <h2 style="color: #f883bb; margin-top: 10px;">{{ env('APP_NAME') }}</h2>
        </td>
    </tr>
        ...
        <td style="padding: 15px;">
            ...
            <table width="100%" cellpadding="5" cellspacing="0">
                ...
                <tr>
                    ...
                    <td>{{ $order->user->prefix }} {{ $order->user->phone_number }}</td>
                </tr>
            </table>
        </td>
    </tr>
                    ...
                    <table width="100%" cellpadding="10" cellspacing="0" style="border:1px solid #ccc; margin-bottom: 10px;">
                        <tr>
                            <td width="100" style="border-left:1px solid #ccc;">
                                <img src="{{ url('storage/' . $detail->course->cover_image) }}" alt="صورة الدورة" width="100" height="100" style="object-fit: contain;">
                            </td>
                            <td style="font-size: 14px;">
                                <strong>📘 {{ $detail->course->title }}</strong><br>
                                💵 السعر: ${{ number_format($detail->course->new_price, 2) }}<br>
                                🕐 المدة: {{ $detail->course->duration }}
                            </td>
                        </tr>
                    </table>
                @endif
    ...
    <tr>
        <td style="text-align: center; padding: 20px; font-size: 12px; color: #666;">
            هذا البريد مرسل تلقائياً من نظام <strong>{{ env('APP_NAME') }}</strong>، شكراً لك!
        </td>
    </tr>
</table>
