...
<div style="max-width: 600px; margin: auto; background: #ffffff; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
    ...
    <div style="padding: 20px;">
        ...
        <p style="background: #f3f3f3; padding: 10px; border-radius: 5px;"><?php echo e($message); ?></p>
    </div>
    <div style="background-color: #f2f2f2; padding: 15px; text-align: center; font-size: 13px; color: #777;">
        This message was sent by <?php echo e(config('app.name')); ?>.
    </div>
</div>
</body>
</html>
<?php /**PATH /home/wimo68zi/api.shiroproperties.com/resources/views/emails/contact.blade.php ENDPATH**/ ?>